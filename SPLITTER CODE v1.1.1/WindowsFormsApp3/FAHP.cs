...
namespace WindowsFormsApp3
{
    public class FAHP
    {
        ...
        public double[,] skalaPBK = new double[,] {{ 1, 2, 3, 3, 5, 7},{((double)1/2), 1, 3, 3, 3, 5},{((double)1/3),((double)1/3), 1, 3, 5, 7},
        ...
        public double[,] skalaPenilaian_Klik = new double[,] { { 1, 5, 7 }, { ((double)1 / 5), 1, 3 }, { ((double)1 / 7), ((double)1 / 3), 1 } };
        //public double[,] skalaPenilaian_Klik = new double[,] { { 1, 5, 7 }, { ((double)1 / 5), 1, 3 }, { ((double)1 / 7), ((double)1 / 3), 1 } };
        public double[,] skalaPenilaian_tyg = new double[,] { { 1, 5, 7 }, { ((double)1 / 5), 1, 3 }, { ((double)1 / 7), ((double)1 / 3), 1 } };
        public double[,] skalaPenilaian_CTR = new double[,] { { 1, 3, 5 }, { ((double)1 / 3), 1, 3 }, { ((double)1 / 5), ((double)1 / 3), 1 } };
        public double[,] skalaPenilaian_SK = new double[,] { { 1, 5, 7 }, { ((double)1 / 5), 1, 3 }, { ((double)1 / 7), ((double)1 / 3), 1 } };
        public double[,] skalaPenilaian_pos = new double[,] { { 1, 5, 7 }, { ((double)1 / 5), 1, 3 }, { ((double)1 / 7), ((double)1 / 3), 1 } };
        public double[,] skalaPenilaian_biaya = new double[,] { { 1, 3, 5, 7 }, { ((double)1 / 3), 1, 3, 5 }, { ((double)1 / 5), ((double)1 / 3), 1, 3 }, { ((double)1 / 7), ((double)1 / 5), ((double)1 / 3), 1 } };
        Dictionary<double, double[]> skalafuzzy = new Dictionary<double, double[]>() {
            ...
            {(5), new double[]{ 3, 5, 7 }},
            {(7), new double[]{ 5, 7, 9 }},
            {((double)1/2), new double[]{((double)1/4), ((double)1/2), 1 }},
            {((double)1/3), new double[]{((double)1/5), ((double)1/3), 1 }},
            {((double)1/5), new double[]{((double)1/7), ((double)1/5), ((double)1/3) }},
            {((double)1/7), new double[]{((double)1/9), ((double)1/7), ((double)1/5) }}
        };
        ...
        public double[] bil_random = new double[] { 0, 0, 0.58, 0.9, 1.12, 1.24, 1.32, 1.41, 1.45, 1.49 };
        ...
        public void hitungBNP()
        {
            ...
            for (int i = 0; i < this.sintesis_performa.GetLength(0); i++)
            {
                ...
                if (this.BNP[i] > best_BNP) {
                    best_group = this.all_data[i].filename;
                    best_BNP = this.BNP[i];
                }
            }
            printArr(this.BNP);

            second.best_group_ads = best_group;
            second.best_group_BNP = best_BNP;
            /*
            Dataset selected_ads = new Dataset(filename);
            AHP ahp = new AHP(selected_ads, this);
